...
const modLinks = [
  { href: '/mod', label: 'Overview', icon: '📊' },
  { href: '/mod/contributions', label: 'Contributions', icon: '📄' },
  { href: '/mod/feedback', label: 'Feedback', icon: '💬' },
  { href: '/mod/tags', label: 'Tags', icon: '🏷️' },
  { href: '/mod/flags', label: 'Flags', icon: '🚩' },
];
...
function ModSidebar() {
  ...
  return (
    <aside className="w-full lg:w-64 flex-shrink-0">
      <nav aria-label="Moderator navigation">
...
function ModShell({ children }: { children: React.ReactNode }) {
  ...
  if (error || !user || !['moderator', 'admin'].includes(user.role)) {
    return (
      <>
        <Header />
        <main id="main-content" className="py-16">
          <div className="container-narrow text-center">
            <div className="card py-12">
              ...
              <h1 className="text-xl font-semibold text-neutral-900 mb-2">Moderator Access Required</h1>
              <p className="text-neutral-600 mb-6">
                {error || 'You need moderator privileges to access this page.'}
              </p>
      ...
      <main id="main-content" className="py-8 lg:py-12">
        <div className="container-wide">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-neutral-900">Moderator Dashboard</h1>
              <p className="text-sm text-neutral-500">Review and moderate community content</p>
            </div>
          </div>
